...
export function WhyChooseUsSection({ content }: { content: { eyebrow: string; title: string; points: string[] } }) {
  return (
    <section id="why-us" className="mx-auto w-full max-w-7xl px-6 py-24 z-10 relative bg-black">
      <div className="space-y-8 rounded-[3rem] border border-white/5 bg-white/[0.01] p-10 lg:p-16 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="mt-6 text-4xl font-bold tracking-tight text-white sm:text-5xl">{content.title}</h2>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {content.points.map((point, index) => (
              ...
              >
                <CheckCircle2 className="text-neutral-500 shrink-0 mt-0.5" size={24} strokeWidth={1.5} />
