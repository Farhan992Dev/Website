    ...
    >
      <div className="grid gap-12 rounded-[3rem] border border-white/5 bg-white/[0.01] p-10 lg:grid-cols-[1.2fr_1fr] lg:p-16 relative overflow-hidden">
          ...
          <div className="flex flex-wrap gap-4 mt-2">
            {content.directContacts.map((item) => (
              <Button
                ...
                asChild
                variant="outline"
                className="rounded-full border-white/10 bg-transparent hover:bg-white/5 text-white px-8 transition-all hover:scale-105"
              >
                <Link
                  href={item.href}
        ...
        <div className="rounded-[2.5rem] border border-white/10 bg-white/[0.02] p-10 relative z-10 flex flex-col justify-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-neutral-300 font-light">
            در صفحه تماس، فرم کامل پروژه در دسترس است و پیام شما برای ادامه
            بررسی دریافت می‌شود.
          </p>
          <div className="mt-8">
            <Button
              asChild
              size="lg"
              className="rounded-full bg-white text-black hover:bg-neutral-200 font-semibold px-8 transition-all hover:scale-105 w-full sm:w-auto"
            >
