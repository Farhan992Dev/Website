      ...
      <div className="mt-16 grid gap-6 md:grid-cols-2">
        {content.items.map((project, index) => (
          ...
          >
            <Link
              href={project.href}
              className="group block h-full rounded-[2.5rem] border border-white/5 bg-white/[0.02] p-8 transition-all hover:bg-white/5 hover:border-white/10 relative overflow-hidden"
            >
