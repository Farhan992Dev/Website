  ...
  return (
    <header className="sticky top-0 z-50 g-main backdrop-blur-xl">
      <div className="mx-auto flex w-full  items-center justify-center  px-8 py-4">
        ...
        {/* Desktop Nav */}
        <nav
          className="hidden items-center w-[60%] gap-8 md:flex"
          aria-label="Primary"
        >
          {content.navigation.items.map((item) => {
            ...
            return (
              <Link
                ...
                className={`
                relative py-2 text-sm font-medium text-white
                transition-colors
        ...
        {/* <div className="hidden items-center gap-4 md:flex">
          <a
            href="tel:09354663872"
            className="inline-flex items-center gap-2 text-sm font-bold text-white bg-white/10 hover:bg-white/20 border border-white/20 px-5 py-2 rounded-full transition-all"
            dir="ltr"
          >
            0935 466 3872
          </a>
          <Button
            asChild
            size="sm"
            className="rounded-full bg-white text-black hover:bg-neutral-200 font-semibold px-6"
          >
        ...
        <div className="flex items-center gap-3 md:hidden relative z-[60]">
          <a
            href="tel:09354663872"
            className="inline-flex items-center text-xs font-bold text-white bg-white/10 active:bg-white/20 border border-white/20 px-3 py-1.5 rounded-full"
            dir="ltr"
          >
            0935 466 3872
          </a>
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute inset-x-0 top-full flex flex-col bg-main /95 backdrop-blur-2xl border-b border-white/10 p-6 shadow-2xl md:hidden"
            >
              <nav className="flex flex-col gap-6" aria-label="Mobile">
                ...
                <div className="pt-4 border-t border-white/10 space-y-4">
                  <a
                    href="tel:09354663872"
                    className="flex items-center justify-center w-full py-2 text-lg font-bold text-white tracking-widest"
                    dir="ltr"
                  >
                    0935 466 3872
                  </a>
                  <Button
                    asChild
                    size="lg"
                    className="w-full rounded-full bg-white text-black hover:bg-neutral-200 font-semibold"
                  >
                    <Link
